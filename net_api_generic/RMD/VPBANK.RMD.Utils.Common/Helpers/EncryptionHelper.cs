...
namespace VPBANK.RMD.Utils.Common.Helpers
{
    public static class EncryptionHelper
    {
        ...
        public static string Encrypt(string clearText, string encryptKey = null)
        {
            if (string.IsNullOrEmpty(encryptKey))
                encryptKey = _EncryptionKey;
        ...
        public static string Decrypt(string cipherText, string encryptKey = null)
        {
